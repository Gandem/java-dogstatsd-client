        ...
        NonBlockingStatsDClientBuilder builder = new NonBlockingStatsDClientBuilder() {
                ...
                public NonBlockingStatsDClient build() {
                    ...
                    return new NonBlockingStatsDClient(resolve()) {
                        @Override
                        ClientChannel createByteChannel(Callable<SocketAddress> addressLookup, int timeout, int connectionTimeout, int bufferSize, boolean isTelemetry) throws Exception {
